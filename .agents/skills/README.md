...
- `local-first-compute`: local source-of-truth workflow for temporary SLURM or Kaggle compute backends, private backend config boundaries, remote package plans, and artifact return checks.
