"""Finalize a pdeagent Task 2 submission from quick-run outputs.
...
Usage:
    python scripts/finalize_pdeagent_task2_submission.py --dry-run
    python scripts/finalize_pdeagent_task2_submission.py --validate
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--run-dir", default="outputs/pdeagent_task2")
    ...
    if args.dry_run:
        ...
        print("[DRY-RUN] Submission finalizer for pdeagent Task 2")
    ...
    experiment_id = parsed.get("experiment_id", "pdeagent_task2") if parsed else "pdeagent_task2"
    ...
    try:
        summary = create_pdeagent_task2_submission(
        ...
        print("Hint: ensure data_and_sample_submission/train_val_test_init/task2_test.h5 exists")
        return 1

    print("\nPdeagent Task 2 submission generated:")
